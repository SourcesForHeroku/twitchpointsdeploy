...
twitch_miner = TwitchChannelPointsMiner(
    ...
    logger_settings=LoggerSettings(
        ...
        telegram=None,
        discord=Discord(
            webhook_api="MYWEBHOOK",  # Discord Webhook URL
            events=[Events.STREAMER_ONLINE, Events.STREAMER_OFFLINE, Events.JOIN_RAID, Events.BET_WIN, Events.GAIN_FOR_RAID],       # Only these events will be sent to the chat
        )
    ),
...
twitch_miner.mine(#MikeJePan Really_Vejny Herdyn
    [
        Streamer("Really_Vejny"),
        Streamer("MikeJePan"),
        Streamer("Herdyn"),
        Streamer("MarweX"),
	Streamer("CzechCloud")
